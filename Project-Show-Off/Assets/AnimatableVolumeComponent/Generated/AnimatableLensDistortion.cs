...
{
    [AnimatableOf(typeof(UnityEngine.Rendering.HighDefinition.LensDistortion))]
    [DisallowMultipleComponent]
    public class AnimatableLensDistortion : AnimatableVolumeComponentBase
    {
        public override Type TargetType { get; } = typeof(UnityEngine.Rendering.HighDefinition.LensDistortion);
        ...
        private void WriteToVolumeComponent(UnityEngine.Rendering.HighDefinition.LensDistortion volumeComponent)
        {
        ...
        private void ReadFromVolumeComponent(UnityEngine.Rendering.HighDefinition.LensDistortion volumeComponent)
        {
            if (!volumeComponent) return;
        ...
        private void Reset()
        {
            ...
            if (!volume || !volume.sharedProfile || !volume.sharedProfile.TryGet<UnityEngine.Rendering.HighDefinition.LensDistortion>(out var volumeComponent)) return;
        ...
        {
            if (!volumeHelper.TryGet<UnityEngine.Rendering.HighDefinition.LensDistortion>(out var volumeComponent)) return;
